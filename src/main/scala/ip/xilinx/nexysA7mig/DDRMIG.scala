...
package sifive.fpgashells.ip.xilinx.nexysA7mig
...
//reused directly in io bundle for sifive.blocks.devices.nexysA7mig
trait DDRMIGClocksResetIO extends Bundle {
  //inputs
...
class DDRMIG(implicit val p:Parameters) extends BlackBox
{
  override def desiredName = "ddrmig128mb"

  val io = new DDR2IO with DDRMIGClocksResetIO {
    // User interface signals
...
//    val device_temp           = Bits(OUTPUT,12)
  ...
  val ddrmig128mbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
    <ModuleName>ddrmig128mbprj</ModuleName>
  ...
  val migprj = ddrmig128mbprj
  val migprjname =  """{/ddrmig128mb.prj}"""
  val modulename =  """ddrmig128mb"""
